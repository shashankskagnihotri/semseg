...
python tool/test_convnext.py --config config/voc2012/test_voc2012_psp50.yaml config.psp_kernel 7 config.save_path runs/pspnet/voc2012/resnet_kernels/kernel_7/model config.save_folder runs/pspnet/voc2012/resnet_kernels_testing/kernel_7/val/ss config.model_path runs/pspnet/voc2012/resnet_kernels/kernel_7/model/best_model.pth
