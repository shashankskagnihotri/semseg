...
parent_dir = "/work/ws-tmp/sa058646-segment/semseg/runs/new_exp_slak/voc2012/unet_plots_full/**/val/ss/frequency/*.pt"
save_path = "/work/ws-tmp/sa058646-segment/semseg/runs/new_exp_slak/voc2012/unet_plots_full/convnext_tiny_freq_comparison_crp_500.png"
all_tensors = glob.glob(parent_dir)
#import ipdb;ipdb.set_trace()

for tensor in all_tensors:
    if 'convnext' in tensor:
