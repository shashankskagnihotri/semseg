...
#from semseg import util.dataset as dataset 
#from semseg import util.transform as transform
#from semseg import util.config as config
...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/voc2012/voc2012_psp50_convnext.yaml', help='config file')
    parser.add_argument('opts', help='see config/ade20k/voc2012_psp50_convnext.yaml for all options', default=None, nargs=argparse.REMAINDER)
...
def main_worker(gpu, ngpus_per_node, argss):
    ...
    if args.distributed:
        ...
        if args.multiprocessing_distributed:
            args.rank = args.rank * ngpus_per_node + len(gpu)
